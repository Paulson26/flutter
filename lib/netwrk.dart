...
class NetworkHandle {
  ...
  Future<http.Response> put(String uri, Map<String, String> body,
    ...
    log.d(body);
    // /user/register
    final uri = Uri.parse('http://10.0.2.2:8000/api/v1/document/$id');
  ...
  Future<http.StreamedResponse> patchImage(String url, String filepath,
    ...
    var request = http.MultipartRequest(
        'PUT', Uri.parse('http://10.0.2.2:8000/api/v1/document/$id'));
  ...
  NetworkImage getImage(String docFile) {
    String uri = formater("http://10.0.2.2:8000$docFile");
